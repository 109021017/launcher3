...
public class Stats {
    ...
    private static final String TAG = "KitKat Launcher/Stats";

    private static final boolean LOCAL_LAUNCH_LOG = true;

    public static final String ACTION_LAUNCH = "org.fabiosilva.kitkatlauncher.action.LAUNCH";
    public static final String PERM_LAUNCH = "org.fabiosilva.kitkatlauncher.permission.RECEIVE_LAUNCH_BROADCASTS";
